...
return (
    ...
    <div className={product_styles.category}>
        ...
        <Card className={product_styles.boxcontainer} >
            <div className={product_styles.image} data-aos="fade-right">
            ...
            <div className={product_styles.content} data-aos="fade-right" >
        ...
        <Card className={product_styles.boxcontainer} >
            <div className={product_styles.content} data-aos="fade-left">
                {/* <span>welcome to our shop</span> */}
                <h3>coconut oil</h3>
            ...
            <div className={product_styles.image} data-aos="fade-left">
